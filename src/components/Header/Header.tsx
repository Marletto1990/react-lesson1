	...
	return (
		<>
			<AppBar
				...
				<Toolbar sx={{ justifyContent: 'start', width: '40%' }}>
					<Box>
						<SvgIcon sx={{ width: '60px', height: '45px' }}>
							<svg
								version='1.0'
                ...
                l0.134,2.789c-0.065,2.857,1.559,3.06,3.807,3.741C77.526,87.536,78.543,90.394,75.754,91.754L75.754,91.754L75.754,91.754z'></path>
								<path
									fillRule='evenodd'
									clipRule='evenodd'
                ...
                l-0.408,1.77L83.062,9.073L83.062,9.073L83.062,9.073z'></path>
							</svg>
						</SvgIcon>
					</Box>
				</Toolbar>
